...
data = dict(
    ...
    train=dict(
        ...
        img_dir='/opt/ml/input/mmseg/images/train_pseudo',
        ann_dir='/opt/ml/input/mmseg/annotations/train_pseudo',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(512, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/mmseg/images/valid',
        ann_dir='/opt/ml/input/mmseg/annotations/valid',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/mmseg/images/test',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = '/opt/ml/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_pseudo/best_mIoU_epoch_27.pth'
resume_from = None
workflow = [('train', 1)]
...
fp16 = dict()
work_dir = './work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_pseudo'
gpu_ids = [0]
auto_resume = False
